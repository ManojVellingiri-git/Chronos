...
export function ConsequenceSimulator({ isOpen, onClose, data }: SimulatorProps) {
      ...
      >
        <div className="max-w-4xl w-full p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <TimelineCard delay={0.2} title="Tomorrow" desc={data?.day_1 || "Calculating..."} />
            <TimelineCard delay={0.6} title="In 3 Days" desc={data?.day_3 || "Calculating..."} />
            <TimelineCard delay={1.0} title="Next Week" desc={data?.day_7 || "Calculating..."} />
          </div>
